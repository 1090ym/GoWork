...
func (x *HelloApply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloApply) ProtoMessage() {}

func (x *HelloApply) ProtoReflect() protoreflect.Message {
	mi := &file_proto_helloworld_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloApply.ProtoReflect.Descriptor instead.
func (*HelloApply) Descriptor() ([]byte, []int) {
	return file_proto_helloworld_proto_rawDescGZIP(), []int{1}
}

func (x *HelloApply) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_proto_helloworld_proto_rawDesc = []byte{
	...
	0x6f, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x65, 0x6c, 0x6c, 0x6f, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x2e,
...
var file_proto_helloworld_proto_goTypes = []interface{}{
	...
	(*HelloApply)(nil),   // 1: helloworld.HelloApply
}
var file_proto_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.Greeter.SayHello:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.Greeter.SayHello:output_type -> helloworld.HelloApply
...
type GreeterClient interface {
	SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloApply, error)
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloApply, error) {
	out := new(HelloApply)
...
type GreeterServer interface {
	SayHello(context.Context, *HelloRequest) (*HelloApply, error)
}
...
func (*UnimplementedGreeterServer) SayHello(context.Context, *HelloRequest) (*HelloApply, error) {
